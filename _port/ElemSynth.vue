...
.flex.flex-wrap.gap-4.relative.p-4
  ...
  .flex.is-group.p-2.items-center
    button.text-button(
      ...
      .i-la-power-off
    button.text-button(
      :style="{ backgroundColor: pitchColor(0, 4) }"
      @mousedown.passive="cycleNote(57)"
      @mouseup.passive="cycleNote(57)"
      @touchstart.prevent.stop="cycleNote(57)"
      @touchend.prevent.stop="cycleNote(57)"
      @mouseleave="cycleNote(57)"
      )
      .i-la-check
